...
import AlcoholMemoryLossPage from '../../../../routes/alcohol-consumption-journey/steps/AlcoholMemoryLossPage';
import { usePageTitleContext } from '../../../../lib/contexts/PageTitleContext';
import { EnumDescriptions } from '../../../../lib/models/enum-descriptions';

describe('AlcoholMemoryLossPage tests', () => {
  ...
  test.each(Object.values(AlcoholEventsFrequency).map((element) => [element]))(
  ...
  test.each(Object.values(AlcoholEventsFrequency).map((element) => [element]))(
    ...
    (answer: AlcoholEventsFrequency) => {
      render(
        <AlcoholMemoryLossPage
          healthCheckAnswers={
            { alcoholMemoryLoss: answer } as IAlcoholConsumption
          }
          updateHealthCheckAnswers={updateHealthCheckAnswersMock}
        />
      );
