...
import AlcoholConcernedRelativePage from '../../../../routes/alcohol-consumption-journey/steps/AlcoholConcernedRelativePage';
import { usePageTitleContext } from '../../../../lib/contexts/PageTitleContext';
import { EnumDescriptions } from '../../../../lib/models/enum-descriptions';

jest.mock('../../../../lib/components/event-audit-button');

describe('AlcoholConcernedRelativePage tests', () => {
  ...
  test.each([
    ...
    (answer: AlcoholPersonInjuredAndConcernedRelative) => {
      render(
        <AlcoholConcernedRelativePage
          healthCheckAnswers={
            { alcoholConcernedRelative: answer } as IAlcoholConsumption
          }
          updateHealthCheckAnswers={updateHealthCheckAnswersMock}
        />
      );
