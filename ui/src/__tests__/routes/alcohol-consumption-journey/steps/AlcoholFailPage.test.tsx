...
import AlcoholFailPage from '../../../../routes/alcohol-consumption-journey/steps/AlcoholFailPage';
import { usePageTitleContext } from '../../../../lib/contexts/PageTitleContext';
import { EnumDescriptions } from '../../../../lib/models/enum-descriptions';
describe('AlcoholFailPage tests', () => {
  ...
  test.each([
    ...
    (answer: AlcoholEventsFrequency) => {
      ...
      expect(updateHealthCheckAnswersMock).toHaveBeenCalledWith({
        alcoholFailedObligations: answer
      });
  ...
  test.each([
    ...
    (answer: AlcoholEventsFrequency) => {
      render(
        <AlcoholFailPage
          healthCheckAnswers={
            { alcoholFailedObligations: answer } as IAlcoholConsumption
          }
          updateHealthCheckAnswers={updateHealthCheckAnswersMock}
        />
      );
