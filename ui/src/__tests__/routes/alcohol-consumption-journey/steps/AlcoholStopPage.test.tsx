...
import AlcoholStopPage from '../../../../routes/alcohol-consumption-journey/steps/AlcoholStopPage';
import { usePageTitleContext } from '../../../../lib/contexts/PageTitleContext';
import { EnumDescriptions } from '../../../../lib/models/enum-descriptions';
describe('AlcoholStopPage tests', () => {
  ...
  test.each([
    ...
    (answer: AlcoholEventsFrequency) => {
      render(
        <AlcoholStopPage
          healthCheckAnswers={
            { alcoholCannotStop: answer } as IAlcoholConsumption
          }
          updateHealthCheckAnswers={updateHealthCheckAnswersMock}
        />
      );
