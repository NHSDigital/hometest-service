...
- **`develop`**: The main integration branch for features. All PRs for new features should target this branch.
...
- **`hotfix/`**: Used for urgent production fixes. Branch off from `main` and merge into both `main` and `develop`.
...
## NHS Standards
All contributions must adhere to the [NHS Service Manual](https://service-manual.nhs.uk/) and [Accessibility Standards](https://service-manual.nhs.uk/accessibility).
