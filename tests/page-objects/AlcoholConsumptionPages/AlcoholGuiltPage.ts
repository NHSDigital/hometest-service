...
export class AlcoholGuiltPage extends HTCPage {
  ...
  readonly howOftenFeltGuiltyErrorLink: Locator;
  ...
  constructor(page: Page) {
    ...
    this.pageHeader = page.locator(
      'h1:has-text("In the past year, how often have you felt guilty")'
    );
    this.howOftenFeltGuiltyErrorLink = page.getByRole('link', {
      name: "Select how often in the past year you've felt guilty or remorseful after drinking"
    });
  ...
  getExpectedTitleHeading(): string {
    return pageTitlesMap[JourneyStepNames.AlcoholGuiltPage];
  }
}
