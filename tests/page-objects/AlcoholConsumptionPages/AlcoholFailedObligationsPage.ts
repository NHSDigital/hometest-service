...
export class AlcoholFailedObligationsPage extends HTCPage {
  ...
  readonly howOftenFailedErrorLink: Locator;

  constructor(page: Page) {
    super(page);
    this.neverRadioButton = page.locator('#alcohol-fail-1');
    this.lessThanMonthlyRadioButton = page.locator('#alcohol-fail-2');
    this.monthlyRadioButton = page.locator('#alcohol-fail-3');
    this.weeklyRadioButton = page.locator('#alcohol-fail-4');
    this.dailyOrAlmostDailyRadioButton = page.locator('#alcohol-fail-5');
    this.continueButton = page.getByText('Continue');
    this.backLink = page.getByText('Back');
    this.pageHeader = page.locator(
      'h1:has-text("In the past year, how often have you failed to do what was expected ")'
    );
    this.howOftenFailedErrorLink = page.getByRole('link', {
      name: "Select how often in the past year you've failed to do what was expected of you because of your drinking"
    });
    this.errorMessage = page.getByText(
      "Error: Select how often in the past year you've failed to do what was expected of you because of your drinking"
    );
  }
  ...
  getExpectedTitleHeading(): string {
    return pageTitlesMap[JourneyStepNames.AlcoholFailPage];
  }
}
