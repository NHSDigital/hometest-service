...
export class AlcoholMorningDrinkPage extends HTCPage {
  ...
  readonly howOftenDrinkInTheMorningErrorLink: Locator;
  ...
  constructor(page: Page) {
    ...
    this.pageHeader = page.locator(
      'h1:has-text("In the past year, how often have you needed an alcoholic drink in the morning")'
    );
    this.howOftenDrinkInTheMorningErrorLink = page.getByRole('link', {
      name: "Select how often in the past year you've needed an alcoholic drink in the morning to get going after a heavy drinking session"
    });
  ...
  getExpectedTitleHeading(): string {
    return pageTitlesMap[JourneyStepNames.AlcoholMorningDrinkPage];
  }
}
