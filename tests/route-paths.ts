export enum RoutePath {
  ...
  WhoShouldNotUseThisOnlineServicePage = '/who-should-not-use-health-check',
  ContactYourGPSurgeryAboutYourNHSHealthCheckPage = '/contact-your-gp-conditions',
  ...
  AnswersSubmittedPage = '/answers-submitted',
...
export enum JourneyStepNames {
  ...
  BloodPressureVeryHighPage = 'very-high-blood-pressure',
  ...
  ProblemFindingAddressPage = 'problem-finding-address',
...
export const pageTitlesMap: PageTitlesMap = {
  ...
  [RoutePath.WhoShouldNotUseThisOnlineServicePage]:
    'Who should not use this online service',
  [RoutePath.ContactYourGPSurgeryAboutYourNHSHealthCheckPage]:
  ...
  [RoutePath.AnswersSubmittedPage]: 'Your answers have been submitted',
  [RoutePath.PostcodeSearch]: 'Postcode search',
  ...
  [RoutePath.WafErrorPage]: 'Access denied',
  ...
  [JourneyStepNames.WhoShouldNotUseThisOnlineServicePage]:
    'Who should not use this online service',
  ...
  [JourneyStepNames.BloodPressureVeryHighPage]:
  ...
  [JourneyStepNames.ProblemFindingAddressPage]: 'Problem finding address',
  ...
  // these are not used as the step value takes precendence
