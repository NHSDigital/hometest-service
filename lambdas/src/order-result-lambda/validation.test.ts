...
describe('validation', () => {
    ...
    describe('extractAndValidateObservationFields', () => {
        ...
        it('returns valid result with observation and identifiers on success', () => {
            ...
            expect(result.validationResult).toEqual({ isValid: true });
    ...
    describe('validateDBData', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(validation, 'extractInterpretationCodeFromFHIRObservation').mockReturnValue(InterpretationCode.Normal);
        });
    ...
    describe('extractOrderUidFromFHIRObservation', () => {
        ...
        it('throws if basedOn is empty array', () => {
            ...
            expect(() => validation.extractOrderUidFromFHIRObservation(observation)).toThrow('Observation.basedOn is empty');
        });

        it('throws if basedOn[0].reference is missing', () => {
            const observation = { basedOn: [{}] } as any;
            expect(() => validation.extractOrderUidFromFHIRObservation(observation)).toThrow('Observation.basedOn[0].reference is missing');
        });

        it('throws if basedOn reference format is invalid', () => {
            const observation = { basedOn: [{ reference: 'InvalidReferenceFormat' }] } as any;
            expect(() => validation.extractOrderUidFromFHIRObservation(observation)).toThrow('Invalid basedOn reference format');
        });
        ...
        it('throws if orderUID is not a valid UUID', () => {
            ...
            expect(() => validation.extractOrderUidFromFHIRObservation(observation)).toThrow('Invalid orderUID format');
        });
    });
    ...
    describe('extractPatientIdFromFHIRObservation', () => {
        ...
        it('throws if subject reference format is invalid', () => {
            ...
            expect(() => validation.extractPatientIdFromFHIRObservation(observation)).toThrow('Invalid subject reference format');
        });
        ...
        it('throws if patient ID is not a valid UUID', () => {
            ...
            expect(() => validation.extractPatientIdFromFHIRObservation(observation)).toThrow('Invalid patient ID format');
        });
    });
    ...
    describe('extractSupplierIdFromFHIRObservation', () => {
        ...
        it('throws if performer reference format is invalid', () => {
            ...
            expect(() => validation.extractSupplierIdFromFHIRObservation(observation)).toThrow('Invalid performer reference format');
        });
