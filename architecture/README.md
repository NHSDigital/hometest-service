...
This directory contains the technical design and interface specifications. For high-level business context, clinical safety documentation, and project roadmaps, please refer to our [Confluence Space](https://nhsd-confluence.digital.nhs.uk/spaces/HOM/pages/1135298574/Architecture).
...
### API Specifications
The service uses [OpenAPI 3.0](https://www.openapis.org/) and [HL7 FHIR](https://www.hl7.org/fhir/) standards for data exchange.
...
Defines the expected interface for external test suppliers. This ensures a consistent integration pattern regardless of the specific vendor fulfillment logic.

### Diagrams
- **[`AWS_Component_Diagram.drawio.png`](./AWS_Component_Diagram.drawio.png)**: A technical diagram showing the AWS resource layout. It illustrates how the Lambda functions, API Gateway, and PostgreSQL database interact within the cloud environment.
