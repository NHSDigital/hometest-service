...
function get-cmd-to-run() {
  ...
  case $check in
    ...
    "staged-changes")
      ...
      ;;
    "current-branch")
      cmd="detect --source $dir --verbose --redact --log-opts --full-history $(git rev-parse --abbrev-ref HEAD)"
      ;;
  esac
...
# + docker run --rm --platform linux/amd64 --volume /home/mikee/git/kainos/code/nhs/code/hometest-service:/workdir --workdir /workdir ghcr.io/gitleaks/gitleaks:v8.18.0@sha256:fd2b5cab12b563d2cc538b14631764a1c25577780e3b7dba71657d58da45d9d9 detect --source /workdir --verbose --redact --config /workdir/scripts/config/gitleaks.toml
# check=staged-changes ./scripts/githooks/scan-secrets.sh
# docker run --rm --platform linux/amd64 --volume /home/mikee/git/kainos/code/nhs/code/hometest-service:/workdir --workdir /workdir ghcr.io/gitleaks/gitleaks:v8.18.0@sha256:fd2b5cab12b563d2cc538b14631764a1c25577780e3b7dba71657d58da45d9d9 protect --source /workdir --verbose --staged --config /workdir/scripts/config/gitleaks.toml
# check=last-commit ./scripts/githooks/scan-secrets.sh
# docker run --rm --platform linux/amd64 --volume /home/mikee/git/kainos/code/nhs/code/hometest-service:/workdir --workdir /workdir ghcr.io/gitleaks/gitleaks:v8.18.0@sha256:fd2b5cab12b563d2cc538b14631764a1c25577780e3b7dba71657d58da45d9d9 detect --source /workdir --verbose --redact --log-opts -1 --config /workdir/scripts/config/gitleaks.toml
